        ...
        <div className='row mx-[42px] max-lg:gap-y-10 max-xl:m-0'>
            <div className='col-12 col-md-6 col-xl-3'>
                <div className='flex items-center justify-center max-md:block '>
                    <div className='max-md:flex max-md:justify-center max-md:items-center max-md:mb-3'>
                        <img decoding="async" src="https://emart.wpthemedemos.com/women-fahion/wp-content/uploads/sites/5/2022/11/Free-shipping-2-10.svg" title="" alt="" loading="lazy" className='max-md:w-[60px] w-[35px]'/>
                    </div>
            ...
            <div className='flex items-center justify-center max-md:block '>
                    <div className='max-md:flex max-md:justify-center max-md:items-center max-md:mb-3'>
                        <img decoding="async"  src="https://emart.wpthemedemos.com/plant-garden/wp-content/uploads/sites/10/2022/12/Quick-payment-svg-10.svg" className="max-md:w-[40px] w-[25px]" alt="Quick-payment-svg-10" loading="lazy" />
                    </div>
            ...
            <div className='flex items-center justify-center  max-md:block '>
                    <div className='max-md:flex max-md:justify-center max-md:items-center max-md:mb-3'>
                        <img decoding="async" src="https://emart.wpthemedemos.com/women-fahion/wp-content/uploads/sites/5/2022/11/Easy-return-1-10.svg" title="" alt="" loading="lazy" className='max-md:w-[60px] w-[35px]'/>
                    </div>
            ...
            <div className='col-12 col-md-6 col-xl-3'>
                <div className='flex items-center justify-center max-md:block '>
                    <div className='max-md:flex max-md:justify-center max-md:items-center max-md:mb-3'>
                        <img decoding="async" src="https://emart.wpthemedemos.com/women-fahion/wp-content/uploads/sites/5/2022/11/Support-1-15.svg" title="" alt="" loading="lazy" className='max-md:w-[50px] w-[35px]'/>
                    </div>
                    <div className='pl-[30px] pr-[15px] max-md:p-0'>
                        <div className='max-md:flex max-md:justify-center max-md:items-center'>
