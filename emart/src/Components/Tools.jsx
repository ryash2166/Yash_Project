...
const Tools = () => {
  return (
    <div className=''>
      ...
      <div className='flex m-auto absolute z-10 h-full max-xl:backdrop-brightness-50 max-md:backdrop-brightness-[.3]'>
      <div className=' mx-[56px] h-[196px] flex justify-end m-auto  max-xl:mx-auto'>
          <div className='ml-[997px] max-2xl:ml-[720px] max-xl:ml-[630px] max-lg:ml-[330px] pr-10 max-sm:pr-0 max-sm:ml-0'>
            <div className='pl-[72px] pr-[101px] max-xl:p-0 max-md:px-[40px]'>
              <div className='text-white mr-[10px] max-md:mr-0'>
                <h2 className='mb-[8px] text-white font-[Jost] text-[45px] max-md:text-[30px] max-md:text-center'>
                  Find your perfect gardening <br className='max-2xl:hidden' /> tools on best price.
                </h2>
              </div>
            </div>
